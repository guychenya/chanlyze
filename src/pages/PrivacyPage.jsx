        ...
        >
          ...
          <div className="space-y-6 text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <p>Chanlyze uses the YouTube Data API v3 to fetch public channel information. Please refer to <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:text-teal-700 font-medium">Google's Privacy Policy</a> for information about how YouTube handles data.</p>
            </section>
            ...
            <section>
              ...
              <p>For questions about this privacy policy, contact us at: <a href="mailto:info@chanlyze@relatech.org" className="text-teal-600 hover:text-teal-700 font-medium">info@chanlyze@relatech.org</a></p>
            </section>
          </div>
        </motion.div>
      </div>
